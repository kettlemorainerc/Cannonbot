...
public class SwerveMotor implements Subsystem, SwerveModule, DriveModuleIF {
    ...
    */
    ...
    public enum MotorPosition{
        // MAX_RPM: 5800
        FRONT_RIGHT(NORTH_EAST,1, 2, 1,2, 0,6.67,2,5600),
        // Max: 5600
        FRONT_LEFT(NORTH_WEST,7, 8, 7,8, 10,6.67,2,5600),
        // Max: 5700
        BACK_RIGHT(SOUTH_EAST,3, 4, 3,4, 11,6.67,2,5600),
        // Max 5700,
        BACK_LEFT(SOUTH_WEST,5, 6, 5,6, 12,6.67,2,5600);
        ...
        private MotorPosition(MecanumMath.WheelPosition wheelPosition, int directionId, int magnitudeId, int encoderChannelA, int encoderChannelB, int hallEffectChannel, double gearRatio, double radius, double maxRPM){
